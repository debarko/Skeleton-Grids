# [Skeleton Grids]
Skeleton Grids is a simple, responsive boilerplate to kickstart any responsive project.
...
- [Download the zip](https://github.com/debarko/Skeleton-Grids/archive/master.zip)
- Clone the repo: `git clone https://github.com/debarko/Skeleton-Grids.git` (Note: this is under active development, so if you're looking for stable and safe, use the zipped download)
...
- Around 100 lines of CSS unminified and with comments
